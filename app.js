...
const init = async () => {
    const exchangeRates = await fetchExchangeRates(getUrl('USD'))
    ...
    conversionPrecisionEl.textContent = `1 USD = ${exchangeRates.conversion_rates.BRL} BRL`    
...
currencyTwoEl.addEventListener('input', async e => {
